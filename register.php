...
<body>
    <form method="POST" class="form_main" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <h1 style="font-family: 'Oswald', sans-serif;">Registration</h1>
        <div class="inputContainer">
            ...
            <input placeholder="Username" autocomplete="off" name="username" id="username" class="inputField" type="text">
        </div>
        ...
        <div class="inputContainer">
            ...
            <input placeholder="Email" autocomplete="off" id="email" name="email" class="inputField" type="email">
        </div>
